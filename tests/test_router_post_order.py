...
# @patch("shopping_cart.controllers.address.find_addresses_by_email")
...
# @patch("shopping_cart.controllers.product.update_product_inventory")
# def test_router_post_order(mock_user_by_email,mock_get_user_cart,mock_addresses_by_email,mock_get_delivery,
#                             mock_update_payment,mock_create_order,mock_delete_cart,mock_get_order_by_id,
#                             mock_update_product_inventory, client_authenticated):
...
#     mock_update_product_inventory.return_value = ExternalAPI(200)
